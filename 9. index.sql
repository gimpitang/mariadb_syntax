...
select * from author where email = 'dudwodpdy@naver.com'
...
-- 만약에 두 컬럼에 각각 index가 설정돼 있다면, mariadb엔진에서 최적의 알고리즘 실행
...
--index 생성
create index eamil_index on author(email);
